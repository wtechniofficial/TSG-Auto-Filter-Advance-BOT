...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/techsoftgeekgroup')
            ],
            [
                InlineKeyboardButton('🙆🏻 Help 🦾', url=f"https://t.me/{temp.U_NAME}?start=help"),
            ],[
            InlineKeyboardButton('⪦ Join TG Channel ⪧', url='https://t.me/moddedapk101')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⪦ Check Our Channel ⪧', url='https://t.me/moddedapk101')
            ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        try:
            ...
            logger.error("Guys, Pehle mujhe channle/Group me Add karo fir Work Start Karo...!")
            return
        btn = [
            [
             ...
             [
                InlineKeyboardButton(
                    "🦋 SUBSCRIBE TG Channel 🦋", url='https://t.me/moddedapk101'
                )
            ]
        ]
    ...
    button = InlineKeyboardButton('✅ Download Link', callback_data=f'generate_stream_link:{file_id}')
    # Create the inline keyboard markup with the button
    keyboard = InlineKeyboardMarkup([[button]])
    await client.send_cached_media(
        chat_id=message.from_user.id,
